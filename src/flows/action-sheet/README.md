...
You can choose to render Click to Pay as a payment method within an action sheet.
...
<form>
  <div id="payment-methods">
    <div>
      <dialog open className={[action-sheet-classes]}>
        <ClickToPay
...
See the full code [here](sample-standalone-click-to-pay/blob/main/src/flows/action-sheet/ActionSheet.tsx).
